...
<form action="{{ route('admin.restaurants.update', $restaurant->slug) }}" method="post">
    ...
    <div>
        ...
        <input required maxlength="255" type="time" name="lunch_time_slot_open" value="{{ old('lunch_time_slot_open', $restaurant->lunch_time_slot_open) }}">
        ...
        <input required maxlength="255" type="time" name="lunch_time_slot_close" value="{{ old('lunch_time_slot_close', $restaurant->lunch_time_slot_close) }}">
    ...
    <div>
        ...
        <input required maxlength="255" type="time" name="dinner_time_slot_open" value="{{ old('dinner_time_slot_open', $restaurant->dinner_time_slot_open) }}">
        ...
        <input required maxlength="255" type="time" name="dinner_time_slot_close" value="{{ old('dinner_time_slot_close', $restaurant->dinner_time_slot_close) }}">
